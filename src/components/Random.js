			...
			<div className='Random'>
				...
				<form onSubmit={this.handleSubmit}>
					<input
						...
						value='gen1'
					/>
					<label htmlFor='gen1'>Generation 1 (Kanto Region)</label>
					<br/>
					...
					/>
					<label htmlFor='gen2'>Generation 2 (Johto Region)</label>
					<br/>
					...
					/>
					<label htmlFor='gen3'>Generation 3 (Hoenn Region)</label>
					<br/>
					...
					<input
						...
						value='genMixed'
					/>
					<label htmlFor='genMixed'>Mixed Generations (All Regions)</label>
					<br/>
