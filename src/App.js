...
class App extends Component {
	static defaultProps = {
		...
		mixedGens: [
			{ id: 149, name: 'Dragonite', type: 'Dragon/Flying', base_experience: 600 },
			{ id: 6, name: 'Charizard', type: 'Fire/Flying', base_experience: 534 },
			{ id: 94, name: 'Gengar', type: 'Ghost/Poison', base_experience: 500 },
			{ id: 376, name: 'Metagross', type: 'Steel/Psychic', base_experience: 600 },
			{ id: 9, name: 'Blastoise', type: 'Water', base_experience: 530 },
			{ id: 248, name: 'Tyranitar', type: 'Rock/Dark', base_experience: 600 }
		]
	};
